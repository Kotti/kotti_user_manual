...
example, imagine that Joe, Sally, and Xavier are the content managers for such
a website, we'll say for a musical act agency. First the Admin user logs in,
creates the three accounts, then sends emails with user names and passwords.
The Admin user creates three top-level sections of the website, notifying Joe,
Sally, and Xavier about their responsibilities: Joe for the Prospects section,
Sally for the Existing Clients section, and Xavier for the Legal Affairs
...
the respective groups as owners of the three website sections. This way,
...
have rights to add and edit content in the Legal Affairs section.
...
For example, a reporter can only write and compile articles, together with
...
intranet workflow, and so on. We dig into the details about workflow next.
